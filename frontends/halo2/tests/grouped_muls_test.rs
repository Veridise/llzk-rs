...
(assert (= (* 1 (+ (* adv_0_0 adv_1_0) (- out_0))) 0))
(end-module)
(begin-module Main)
(input in_0)
(output out_0)
(call [cout_0_0] test_group [])
(assert (= adv_2_0 cout_0_0))
...
(begin-module test_group)
(output out_0)
(assert (= (- adv_0_0) adv_1_0))
(assert (= (* adv_0_0 adv_1_0) out_0))
(end-module)
(begin-module Main)
(input in_0)
(output out_0)
(call [out_0] test_group [])
(end-module)
";

#[cfg(feature = "picus-backend")]
#[test]
fn grouped_muls_circuit_picus() {
    common::setup();
    common::picus_test(
...
#[cfg(feature = "picus-backend")]
#[test]
fn grouped_muls_opt_circuit_picus() {
    common::setup();
    common::picus_test(
        MulCircuit::<Fr>::default(),
