...
///
/// Mimics [Operation][`melior::ir::operation::Operation`] and the reference types mimic [OperationRef][`melior::ir::operation::OperationRef`] and [OperationRefMut][`melior::ir::operation::OperationRefMut`].
///
